    ...
    <Card>
      ...
      <CardContent sx={{ '& .apexcharts-xcrosshairs.apexcharts-active': { opacity: 0 } }}>
        <AppReactApexCharts
          ...
          height={206}
          width='100%'
          series={[{ name: 'Messages', data: [18000, 20000, 21000, 19000, 22000, 23000, 21500] }]}
          options={options}
        />
        <div className='flex items-center mbe-4 gap-4'>
          <Typography variant='h4'>21,500</Typography>
          <Typography>Messages sent on the busiest day this week</Typography>
        </div>
